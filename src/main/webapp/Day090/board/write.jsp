...
<div class="container"  style="margin-top:5%; min-height:500px">
	<h3>MULTIBOARD - 글쓰기 </h3>
		<form action="<%=request.getContextPath()%>/write.re" method="post"  id="writeForm">
		   <fieldset>
		   <legend>WRITE(CREATE)</legend>
			...
			<div class="form-group  text-right">
				...
				<a href="<%=request.getContextPath()%>/reply_view.re" class="btn btn-default" style="color:white; background-color:#f4511e">답변</a>  
				<a href="<%=request.getContextPath()%>/list.re"   class="btn btn-default">목록보기</a>
			</div>
		 </fieldset>		
		</form> <!-- end form -->	
</div>
